...
(function () {
    ...
    function prepareComponentList(componentSelector, components) {
        ...
        console.log('Creating choices from list', choiceList);
        ...
        choices.passedElement.addEventListener('choice', function (value) {
            window.location.href = value;
        }, false);
    }

    function parseComponentList(componentSelector) {
        return function(event) {
            var request = event.target;
            if (request.readyState === request.DONE && request.status === 200) {
                prepareComponentList(componentSelector, JSON.parse(request.responseText));
            }
        };
    }

    function loadComponentList(componentSelector) {
        console.log('Loading component list');
        var request                = new XMLHttpRequest();
        request.onreadystatechange = parseComponentList(componentSelector);
    ...
    loadComponentList(componentSelector);
})();
